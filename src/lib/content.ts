...
export const FAQ_ITEMS = [
  ...
  {
    q: "How do I qualify?",
    a: "Spend 35 hours building projects on [horizons.hackclub.com](https://horizons.hackclub.com/) before June 30, 2026, then spend your hours to get a ticket to Horizons Crux. Your hours are tracked automatically with [Hackatime](https://hackatime.hackclub.com).",
  },
  {
    q: "Where do I sleep?",
